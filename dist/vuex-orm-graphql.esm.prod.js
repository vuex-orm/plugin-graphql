...
function cloneDeep$1(target) {
    ...
    if (isArray(target)) {
        ...
        return cp_1.map(function (n) { return cloneDeep$1(n); });
    }
    if (typeof target === 'object' && target !== {}) {
        var cp_2 = __assign$1({}, target);
        Object.keys(cp_2).forEach(function (k) { return (cp_2[k] = cloneDeep$1(cp_2[k])); });
        return cp_2;
    }
    return target;
}
...
var Number$1 = /** @class */ (function (_super) {
    __extends$1(Number, _super);
    /**
...
var HasManyThrough = /** @class */ (function (_super) {
    __extends$1(HasManyThrough, _super);
    /**
...
var BelongsToMany = /** @class */ (function (_super) {
    __extends$1(BelongsToMany, _super);
    /**
     * Create a new belongs to instance.
     */
    ...
    BelongsToMany.prototype.createPivotRecord = function (data, record, related) {
        ...
        related.forEach(function (id) {
            ...
            data[_this.pivot.entity] = __assign$1(__assign$1({}, data[_this.pivot.entity]), (_a = {}, _a[pivotKey] = __assign$1(__assign$1(__assign$1({}, pivotRecord), pivotData), (_b = { $id: pivotKey }, _b[_this.foreignPivotKey] = parentId, _b[_this.relatedPivotKey] = relatedId, _b)), _a));
        });
    };
...
var MorphToMany = /** @class */ (function (_super) {
    __extends$1(MorphToMany, _super);
    /**
     * Create a new belongs to instance.
     */
    ...
    MorphToMany.prototype.createPivotRecord = function (parent, data, record, related) {
        ...
        related.forEach(function (id) {
            ...
            var pivotData = data[_this.related.entity][id][_this.pivotKey] || {};
            data[_this.pivot.entity] = __assign$1(__assign$1({}, data[_this.pivot.entity]), (_a = {}, _a[pivotKey] = __assign$1(__assign$1({}, pivotData), (_b = { $id: pivotKey }, _b[_this.relatedId] = relatedId, _b[_this.id] = parentId, _b[_this.type] = parent.entity, _b)), _a));
        });
    };
    return MorphToMany;
}(Relation));
...
var MorphedByMany = /** @class */ (function (_super) {
    __extends$1(MorphedByMany, _super);
    /**
     * Create a new belongs to instance.
     */
    ...
    MorphedByMany.prototype.createPivotRecord = function (data, record, related) {
        ...
        related.forEach(function (id) {
            ...
            var pivotData = data[_this.related.entity][id][_this.pivotKey] || {};
            data[_this.pivot.entity] = __assign$1(__assign$1({}, data[_this.pivot.entity]), (_a = {}, _a[pivotKey] = __assign$1(__assign$1({}, pivotData), (_b = { $id: pivotKey }, _b[_this.relatedId] = parentId, _b[_this.id] = _this.model.getIdFromRecord(data[_this.related.entity][id]), _b[_this.type] = _this.related.entity, _b)), _a));
        });
    };
...
function toJson(model, option) {
    ...
    option = __assign$1(__assign$1({}, defaultOption), option);
    var record = {};
...
function create(context, payload) {
    return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            state = context.state;
            entity = state.$name;
            return [2 /*return*/, context.dispatch(state.$connection + "/create", __assign$1(__assign$1({}, payload), { entity: entity }), { root: true })];
        });
    });
}
/**
...
function insert(context, payload) {
    return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            state = context.state;
            entity = state.$name;
            return [2 /*return*/, context.dispatch(state.$connection + "/insert", __assign$1(__assign$1({}, payload), { entity: entity }), { root: true })];
        });
    });
}
/**
...
function update(context, payload) {
    return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            ...
            return [2 /*return*/, context.dispatch(state.$connection + "/update", __assign$1({ entity: entity }, payload), { root: true })];
        });
    });
}
/**
...
function insertOrUpdate(context, payload) {
    return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            state = context.state;
            entity = state.$name;
            return [2 /*return*/, context.dispatch(state.$connection + "/insertOrUpdate", __assign$1({ entity: entity }, payload), { root: true })];
        });
    });
}
...
var visit$1 = function visit(value, parent, key, schema, addEntity, visitedEntities) {
...
var normalize$1$1 = function normalize(input, schema) {
  ...
  var visitedEntities = {};
  var result = visit$1(input, input, null, schema, addEntity, visitedEntities);
  return {
    entities: entities,
    result: result
  };
    ...
    WhereFilter.getComparator = function (query, record) {
        ...
        return function (where) {
            ...
            if (typeof where.field === 'function') {
                var newQuery = new Query$1(query.store, query.entity);
...
var Query$1 = /** @class */ (function () {
    ...
    Query.prototype.whereIdIn = function (values) {
        ...
        if (this.model.isCompositePrimaryKey()) {
            var idList = values.reduce(function (keys, value) {
                return __spreadArrays$1(keys, [_this.normalizeIndexId(value)]);
            }, []);
    ...
    Query.prototype.processUpdate = function (data, instance) {
        ...
        if (instance.constructor !== this.model && instance instanceof Model$1) {
            return this.hydrate(__assign$1(__assign$1({}, instance), data), instance.constructor);
        }
        return this.hydrate(__assign$1(__assign$1({}, instance), data));
    };
    /**
    ...
    Query.prototype.insertOrUpdateRecords = function (records) {
        ...
        return __spreadArrays$1(this.insertRecords(toBeInserted), this.updateRecords(toBeUpdated));
    };
    /**
    ...
    Query.prototype.commit = function (name, payload) {
        this.store.commit(this.database.namespace + "/" + name, __assign$1({ entity: this.baseEntity }, payload));
    };
    /**
    ...
    Query.prototype.hydrate = function (record, forceModel) {
        ...
        if (!this.appliedOnBase && record[this.model.typeKey] === undefined) {
            ...
            record = __assign$1(__assign$1({}, record), (_a = {}, _a[this.model.typeKey] = typeValue, _a));
    ...
    Query.prototype.hydrateRecordsByMerging = function (records) {
        ...
        return Object.keys(records).reduce(function (instances, id) {
            ...
            if (modelForRecordInStore === null) {
                instances[id] = _this.hydrate(__assign$1(__assign$1({}, recordInStore), record));
                return instances;
            }
            instances[id] = _this.hydrate(__assign$1(__assign$1({}, recordInStore), record), modelForRecordInStore);
            return instances;
        }, {});
    };
    /**
...
function query$1(_state) {
    var _this = this;
    return function (entity) { return new Query$1(_this, entity); };
}
/**
 * Get all data of given entity.
 */
function all$1(_state) {
    var _this = this;
    return function (entity) { return (new Query$1(_this, entity)).all(); };
}
/**
 * Find a data of the given entity by given id.
 */
function find$1(_state) {
    ...
    return function (entity, id) {
        return (new Query$1(_this, entity)).find(id);
    };
}
/**
 * Find a data of the given entity by given id.
...
function findIn$1(_state) {
    ...
    return function (entity, idList) {
        return (new Query$1(_this, entity)).findIn(idList);
    };
}
var RootGetters = {
    query: query$1,
...
function newRecord$1(_context, payload) {
    return __awaiter$1(this, void 0, void 0, function () {
        return __generator$1(this, function (_a) {
            return [2 /*return*/, (new Query$1(this, payload.entity)).new()];
        });
    });
}
/**
...
function create$1(_context, payload) {
    return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            ...
            return [2 /*return*/, (new Query$1(this, entity)).create(data, options)];
        });
    });
}
/**
...
function insert$1(_context, payload) {
    return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            ...
            data = payload.data;
            options = OptionsBuilder.createPersistOptions(payload);
            return [2 /*return*/, (new Query$1(this, entity)).insert(data, options)];
        });
    });
}
/**
...
function update$1(_context, payload) {
    return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            ...
            options = OptionsBuilder.createPersistOptions(payload);
            return [2 /*return*/, (new Query$1(this, entity)).update(data, where, options)];
        });
    });
}
/**
...
function insertOrUpdate$1(_context, payload) {
    return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            ...
            data = payload.data;
            options = OptionsBuilder.createPersistOptions(payload);
            return [2 /*return*/, (new Query$1(this, entity)).insertOrUpdate(data, options)];
        });
    });
}
function destroy$1(_context, payload) {
    return __awaiter$1(this, void 0, void 0, function () {
        ...
        return __generator$1(this, function (_a) {
            ...
            return [2 /*return*/, (new Query$1(this, entity)).delete(where)];
        });
    });
}
/**
    ...
    return __awaiter$1(this, void 0, void 0, function () {
        return __generator$1(this, function (_a) {
            if (payload && payload.entity) {
                (new Query$1(this, payload.entity)).deleteAll();
                return [2 /*return*/];
            }
            Query$1.deleteAll(this);
            return [2 /*return*/];
        });
    });
}
...
var Connection = /** @class */ (function () {
    ...
    Connection.prototype.insert = function (record) {
        var _a;
        this.state.data = __assign$1(__assign$1({}, this.state.data), (_a = {}, _a[record.$id] = record, _a));
    };
    /**
     * Insert the given records.
     */
    Connection.prototype.insertRecords = function (records) {
        this.state.data = __assign$1(__assign$1({}, this.state.data), records);
    };
    /**
...
var Database = /** @class */ (function () {
    ...
    Database.prototype.createSubState = function (entity) {
        ...
        return function () { return (__assign$1(__assign$1(__assign$1({}, modelState), moduleState), { $connection: _this.namespace, $name: name, data: {} })); };
    };
    /**
     * Create sub getters.
     */
    Database.prototype.createSubGetters = function (entity) {
        return __assign$1(__assign$1({}, Getters), entity.module.getters);
    };
    /**
     * Create sub actions.
     */
    Database.prototype.createSubActions = function (entity) {
        return __assign$1(__assign$1({}, Actions), entity.module.actions);
    };
    /**
    ...
    Database.prototype.registerSchema = function (entity) {
        this.schemas[entity.name] = Schema$1.create(entity.model);
    };
    /**
    ...
    Database.prototype.checkModelTypeMappingCapability = function (model) {
        ...
        if (baseModel && baseModel.types === Model$1.types) {
...
class PatchedModel extends Model$1 {
    constructor() {
        super(...arguments);
...
export { ArgumentMode, ConnectionMode, DefaultAdapter, Mock, Model, PatchedModel, clearORMStore, mock, setupTestUtils };
