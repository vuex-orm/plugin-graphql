...
var Apollo = /** @class */ (function () {
    ...
    Apollo.prototype.simpleQuery = function (query, variables, bypassCache, context) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                fetchPolicy = bypassCache ? 'network-only' : 'cache-first';
                return [2 /*return*/, this.apolloClient.query({ query: graphql_tag_1.default(query), variables: variables, fetchPolicy: fetchPolicy, context: { headers: Apollo.getHeaders() } })];
            });
        });
    };
    Apollo.prototype.simpleMutation = function (query, variables, context) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.apolloClient.mutate({ mutation: graphql_tag_1.default(query), variables: variables, context: { headers: Apollo.getHeaders() } })];
            });
        });
    };
