 ...
 */
var Model$1 = /** @class */ (function () {
    function Model$$1(baseModel) {
        var _this = this;
        this.fields = new Map();
     ...
     */
    Model$$1.prototype.getQueryFields = function () {
        var _this = this;
        var fields = [];
     ...
     */
    Model$$1.prototype.getRelations = function () {
        var _this = this;
    ...
    Model$$1.prototype.fieldIsAttribute = function (field) {
...
var visitor = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.visit = visit;
...
function getFragmentQueryDocument(document, fragmentName) {
    ...
    var query = __assign$12({}, document, { definitions: [
            {
...
function createOperation(starting, operation) {
    var context = __assign$13({}, starting);
    var setContext = function (next) {
        if (typeof next === 'function') {
            context = __assign$13({}, context, next(context));
        }
        else {
            context = __assign$13({}, context, next);
        }
    };
    var getContext = function () { return (__assign$13({}, context)); };
...
var Observable$2 = (function (_super) {
    __extends$16(Observable$$1, _super);
...
var ApolloError = (function (_super) {
    __extends$17(ApolloError, _super);
...
var ObservableQuery = (function (_super) {
    __extends$18(ObservableQuery, _super);
    ...
    ObservableQuery.prototype.currentResult = function () {
        ...
        if (!partial) {
            var stale = false;
            this.lastResult = __assign$14({}, result, { stale: stale });
        }
        return __assign$14({}, result, { partial: partial });
    };
    ...
    ObservableQuery.prototype.refetch = function (variables) {
        ...
        if (!isEqual(this.variables, variables)) {
            this.variables = __assign$14({}, this.variables, variables);
        }
        if (!isEqual(this.options.variables, this.variables)) {
            this.options.variables = __assign$14({}, this.options.variables, this.variables);
        }
        var combinedOptions = __assign$14({}, this.options, { fetchPolicy: 'network-only' });
    ...
    ObservableQuery.prototype.fetchMore = function (fetchMoreOptions) {
        ...
        return Promise.resolve()
            ...
            if (fetchMoreOptions.query) {
                ...
                combinedOptions = __assign$14({}, _this.options, fetchMoreOptions, { variables: __assign$14({}, _this.variables, fetchMoreOptions.variables) });
            }
    ...
    ObservableQuery.prototype.setOptions = function (opts) {
        ...
        this.options = __assign$14({}, this.options, opts);
    ...
    ObservableQuery.prototype.setVariables = function (variables, tryFetch, fetchResults) {
        ...
        this.isTornDown = false;
        var newVariables = __assign$14({}, this.variables, variables);
        if (isEqual(newVariables, this.variables) && !tryFetch) {
            ...
            return this.queryManager
                .fetchQuery(this.queryId, __assign$14({}, this.options, { variables: this.variables }))
                .then(function (result) { return maybeDeepFreeze(result); });
        }
    };
...
var QueryStore = (function () {
    ...
    QueryStore.prototype.reset = function (observableQueryIds) {
        ...
        this.store = Object.keys(this.store)
            ...
            res[key] = __assign$16({}, _this.store[key], { networkStatus: NetworkStatus.loading });
            return res;
        }, {});
    };
    return QueryStore;
...
var QueryManager = (function () {
    ...
    QueryManager.prototype.mutate = function (_a) {
        ...
        return new Promise(function (resolve, reject) {
            var storeResult;
            var error;
            var operation = _this.buildOperationForLink(mutation, variables, __assign$17({}, context, { optimisticResponse: optimisticResponse }));
    ...
    QueryManager.prototype.watchQuery = function (options, shouldSubscribe) {
        ...
        var transformedOptions = __assign$17({}, options);
        return new ObservableQuery({
    ...
    QueryManager.prototype.fetchRequest = function (_a) {
        ...
        var operation = this.buildOperationForLink(document, variables, __assign$17({}, context, { forceFetch: !this.queryDeduplication }));
        var resultFromStore;
        var errorsFromStore;
    ...
    QueryManager.prototype.getQuery = function (queryId) {
        return this.queries.get(queryId) || __assign$17({}, defaultQueryInfo);
    };
    QueryManager.prototype.setQuery = function (queryId, updater) {
        var prev = this.getQuery(queryId);
        var newInfo = __assign$17({}, prev, updater(prev));
    ...
    QueryManager.prototype.buildOperationForLink = function (document, variables, extraContext) {
        ...
        return {
            ...
            context: __assign$17({}, extraContext, { cache: cache, getCacheKey: function (obj) {
                    if (cache.config) {
...
var __assign$18 = (undefined && undefined.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
            t[p] = s[p];
...
var ApolloClient = (function () {
    ...
    ApolloClient.prototype.watchQuery = function (options) {
        ...
        if (this.defaultOptions.watchQuery) {
            options = __assign$18({}, this.defaultOptions.watchQuery, options);
        }
        if (this.disableNetworkFetches && options.fetchPolicy === 'network-only') {
            options = __assign$18({}, options, { fetchPolicy: 'cache-first' });
        }
    ...
    ApolloClient.prototype.query = function (options) {
        ...
        if (this.defaultOptions.query) {
            options = __assign$18({}, this.defaultOptions.query, options);
        }
    ...
    ApolloClient.prototype.mutate = function (options) {
        ...
        if (this.defaultOptions.mutate) {
            options = __assign$18({}, this.defaultOptions.mutate, options);
        }
...
var __assign$19 = (undefined && undefined.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
            t[p] = s[p];
...
var selectHttpOptionsAndBody = function (operation, fallbackConfig) {
    ...
    var options = __assign$19({}, fallbackConfig.options, { headers: fallbackConfig.headers, credentials: fallbackConfig.credentials });
    var http = fallbackConfig.http;
    configs.forEach(function (config) {
        options = __assign$19({}, options, config.options, { headers: __assign$19({}, options.headers, config.headers) });
        if (config.credentials)
            options.credentials = config.credentials;
        http = __assign$19({}, http, config.http);
    });
...
var __assign$20 = (undefined && undefined.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
            t[p] = s[p];
...
var ApolloCache = (function () {
    ...
    ApolloCache.prototype.writeData = function (_a) {
        ...
        if (typeof id !== 'undefined') {
            ...
            var dataToWrite = __assign$20({ __typename: __typename }, data);
            this.writeFragment({
                id: id,
...
var __assign$21 = (undefined && undefined.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
            t[p] = s[p];
...
var WriteError = (function (_super) {
    __extends$21(WriteError, _super);
    function WriteError() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
...
function mergeWithGenerated(generatedKey, realKey, cache) {
    ...
    Object.keys(generated).forEach(function (key) {
        ...
        cache.set(realKey, __assign$21({}, generated, real));
    });
}
...
function writeFieldToStore(_a) {
    ...
    var newStoreObj = __assign$21({}, store.get(dataId), (_b = {}, _b[storeFieldName] = storeValue, _b));
    if (shouldMerge) {
        ...
        if (isField(selection)) {
            ...
            if (fieldResult !== undefined) {
                if (result[resultFieldKey] === undefined) {
                    ...
                    merge$1(result[resultFieldKey], fieldResult);
                }
            }
        }
        else {
...
function merge$1(dest, src) {
    ...
    Object.keys(dest).forEach(function (destKey) {
        if (src.hasOwnProperty(destKey)) {
            merge$1(dest[destKey], src[destKey]);
        }
    });
...
var __assign$22 = (undefined && undefined.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
            t[p] = s[p];
...
function readQueryFromStore(options) {
    ...
    return diffQueryAgainstStore(__assign$22({}, options, optsPatch)).result;
}
...
function addPreviousResultToIdValues(value, previousResult) {
    if (isIdValue(value)) {
        return __assign$22({}, value, { previousResult: previousResult });
    }
    else if (Array.isArray(value)) {
...
var __assign$23 = (undefined && undefined.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
            t[p] = s[p];
...
var RecordingCache = (function () {
    ...
    RecordingCache.prototype.toObject = function () {
        return __assign$23({}, this.data, this.recordedData);
    };
    ...
    RecordingCache.prototype.replace = function (newData) {
        this.clear();
        this.recordedData = __assign$23({}, newData);
    };
...
var __assign$24 = (undefined && undefined.__assign) || Object.assign || function(t) {
    for (var s, i = 1, n = arguments.length; i < n; i++) {
        s = arguments[i];
        for (var p in s) if (Object.prototype.hasOwnProperty.call(s, p))
            t[p] = s[p];
...
var InMemoryCache = (function (_super) {
    __extends$22(InMemoryCache, _super);
    function InMemoryCache(config) {
        ...
        _this.config = __assign$24({}, defaultConfig, config);
...
var invariant_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
unwrapExports$1(source);
var source_1 = source.Source;

var location = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
unwrapExports$1(location);
var location_1 = location.getLocation;

var printError_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
unwrapExports$1(printError_1);
var printError_2 = printError_1.printError;

var GraphQLError_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
unwrapExports$1(GraphQLError_1);
var GraphQLError_2 = GraphQLError_1.GraphQLError;

var syntaxError_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
unwrapExports$1(syntaxError_1);
var syntaxError_2 = syntaxError_1.syntaxError;

var locatedError_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
unwrapExports$1(locatedError_1);
var locatedError_2 = locatedError_1.locatedError;

var formatError_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
unwrapExports$1(error);

var blockStringValue_1 = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
unwrapExports$1(blockStringValue_1);

var lexer = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
...
var directiveLocation = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
/**
...
unwrapExports$1(directiveLocation);
var directiveLocation_1 = directiveLocation.DirectiveLocation;

var parser = createCommonjsModule$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.parse = parse;
    ...
    QueryBuilder.prototype.buildRelationsQuery = function (model, ignoreModels) {
        ...
        model.getRelations().forEach(function (field, name) {
            ...
            if (_this.shouldEagerLoadRelation(model, field, relatedModel) &&
                ...
                var multiple = !(field instanceof BelongsTo);
...
var VuexORMApollo = /** @class */ (function () {
    ...
    VuexORMApollo.prototype.collectModels = function () {
        ...
        this.database.entities.forEach(function (entity) {
            var model = new Model$1(entity.model);
