...
describe('Transformer', () => {
  ...
  describe('.transformOutgoingData', () => {
    test('transforms models to a useful data hashmap', async () => {
      ...
      const transformedData = Transformer.transformOutgoingData(context.getModel('video'), video, false)
  ...
  describe('.transformIncomingData', () => {
    test('transforms incoming data into a Vuex-ORM readable structure', () => {
      ...
      expect(Transformer.transformIncomingData((incomingData1 as unknown) as Data, tariff, false)).toEqual(
        expectedData1
      )
      expect(Transformer.transformIncomingData((incomingData2 as unknown) as Data, post, false)).toEqual(expectedData2)
    })
    ...
    test('transforms incoming data after a mutation into a Vuex-ORM readable structure', () => {
      ...
      const transformedData = Transformer.transformIncomingData((incomingData as unknown) as Data, model, true)
  ...
  describe('.shouldIncludeOutgoingField', () => {
    test('works', () => {
      ...
      expect(Transformer.shouldIncludeOutgoingField(false, 'posts', 15, user, ['posts'])).toEqual(true)
